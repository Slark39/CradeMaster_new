...
export interface OracleFetcher {
  ...
  fetchOracleCandles_bsc(symbol: string, interval: string, limit: number): Promise<FromNewToOldArray<Bar>>;
  // fetchOracleCandles_pio(symbol: string, interval: string, limit: number): Promise<FromNewToOldArray<Bar>>;
