  ...
  return (
    <div key={order.key}>
      <div className="flex items-start justify-between gap-6">
        <Button
          variant="secondary"
          className="!block w-full !bg-slate-800 !bg-opacity-15 !p-6 hover:!bg-opacity-20 active:!bg-opacity-25"
        ...
        <Button
          variant="secondary"
          className="!bg-slate-800 !bg-opacity-15 !p-6 hover:!bg-opacity-20 active:!bg-opacity-25"
