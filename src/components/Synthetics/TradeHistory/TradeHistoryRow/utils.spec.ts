    ...
    expect(formatPositionMessage(createOrderDecreaseLong, minCollateralUsd)).toMatchInlineSnapshot(`
      {
        ...
        "priceImpact": undefined,
        "size": "-$266.23",
        "timestamp": "15 Sep 2025, 13:29",
        "timestampISO": "2025-09-15T13:29:36+04:00",
    ...
    expect(formatPositionMessage(cancelOrderIncreaseLong, minCollateralUsd)).toMatchInlineSnapshot(`
      {
        ...
        "priceImpact": undefined,
        "size": "+$4.11",
        "timestamp": "15 Sep 2025, 13:37",
        "timestampISO": "2025-09-15T13:37:13+04:00",
    ...
    expect(formatPositionMessage(createOrderIncreaseLong, minCollateralUsd)).toMatchInlineSnapshot(`
      {
        ...
        "priceImpact": undefined,
        "size": "+$2.64",
        "timestamp": "15 Sep 2025, 14:54",
        "timestampISO": "2025-09-15T14:54:04+04:00",
        "triggerPrice": "<  $1.00",
      }
    `);
    ...
    expect(formatPositionMessage(executeOrderIncreaseLong, minCollateralUsd)).toMatchInlineSnapshot(`
      {
        ...
        "priceImpact": "-$16.82",
        "size": "+$2,070.18",
        "timestamp": "18 Sep 2025, 16:43",
        "timestampISO": "2025-09-18T16:43:18+04:00",
      }
    `);
    ...
    expect(formatPositionMessage(frozenOrderIncreaseShort, minCollateralUsd)).toMatchInlineSnapshot(`
      {
        ...
        "size": "+$1,348.82",
        "timestamp": "18 Sep 2025, 15:14",
        "timestampISO": "2025-09-18T15:14:09+04:00",
      }
    `);
    ...
    expect(formatPositionMessage(undefinedOrder, minCollateralUsd)).toMatchInlineSnapshot(`
{
  ...
  "priceImpact": undefined,
  "size": "-$4,954.24",
  "timestamp": "18 Sep 2025, 11:52",
  "timestampISO": "2025-09-18T11:52:39+04:00",
}
`);
    ...
    expect(formatPositionMessage(liquidated, minCollateralUsd)).toMatchInlineSnapshot(`
{
  ...
  "priceImpact": "-$16.82",
  "size": "-$6,441.90",
  "timestamp": "04 Sep 2025, 06:38",
  "timestampISO": "2025-09-04T06:38:49+04:00",
}
`);
    ...
    expect(formatPositionMessage(increaseLongETH, minCollateralUsd)).toMatchInlineSnapshot(`
{
  ...
  "priceImpact": "-$0.08",
  "size": "+$49.83",
  "timestamp": "21 Sep 2025, 19:32",
  "timestampISO": "2025-09-21T19:32:40+04:00",
}
`);
  });
    ...
    expect(formatSwapMessage(requestSwap)).toMatchInlineSnapshot(`
{
  ...
  "timestamp": "02 Oct 2025, 18:35",
  "timestampISO": "2025-10-02T18:35:16+04:00",
}
`);
    expect(formatSwapMessage(executeSwap)).toMatchInlineSnapshot(`
{
  ...
  "timestamp": "02 Oct 2025, 06:08",
  "timestampISO": "2025-10-02T06:08:40+04:00",
}
`);
    // LIMIT SWAPS
    expect(formatSwapMessage(executeOrderSwap)).toMatchInlineSnapshot(`
{
  ...
  "timestamp": "29 Sep 2025, 10:46",
  "timestampISO": "2025-09-29T10:46:39+04:00",
}
`);
