  ...
  return (
    <div className={cx("relative cursor-pointer rounded-4 border border-gray-800 p-0", className)}>
      <input
        ...
        className={cx("block w-full bg-scroll bg-[12px_center] bg-no-repeat placeholder-slate-800", {
      ...
      >
        <div
          className={cx(
            ...
            "group-hover:bg-[#50577e99] group-hover:text-slate-800 group-focus:bg-[#50577e99] group-focus:text-slate-800",
