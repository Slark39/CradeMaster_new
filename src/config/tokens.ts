...
export const TOKENS: { [chainId: number]: Token[] } = {
  ...
  [BSС_MAINNET]: [
    ...
    },
    {
      ...
      isNative: false,
      isShortable: true,
      imageUrl: "https://assets.coingecko.com//coins/images/15468/standard/NxLfA-LK_400x400.png?1696515114",
      coingeckoUrl: "https://www.coingecko.com/en/coins/tron-bsc",
      isV1Available: true,
    },
    {
      name: "Bitcoin (WBTC)",
...
const CHAIN_IDS = [ARBITRUM, ARBITRUM_GOERLI, AVALANCHE, AVALANCHE_FUJI, BSС_MAINNET];
